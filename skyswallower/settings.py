"""
Django settings for skyswallower project.
...
SECRET_KEY = 'q*k*smq@$a@!!z#bag5*ph49eb=y%a(q_@x#)zwloisi9je0eu'
...
ROOT_URLCONF = 'skyswallower.urls'
...
WSGI_APPLICATION = 'skyswallower.wsgi.application'
